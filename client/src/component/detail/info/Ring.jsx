...
export default function Ring({ infoList }) {
  return (
    <div>
      {/* 상단 섹션 */}
      <div className="relative aspect-[2.21]">
      <video
            autoPlay
            playsInline
            loop
      ...
      <div className="flex p-32 pb-0 bg-gray2">
        <div className="bg-yellow p-[2.083vw] w-[30%] rounded-l-[1.1vw] flex flex-col gap-16">
          <InfoBlock
      ...
      <div className="flex flex-row gap-[2.083vw] bg-gray2 p-32 pb-0">
        <div className="bg-white w-[70%] rounded-[1.1vw]">
          <img className="rounded-t-[1.1vw] w-full" src={infoList[2].image} alt="" />
          <InfoBlock
